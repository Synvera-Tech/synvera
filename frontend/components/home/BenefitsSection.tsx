...
const cardBase =
  "p-10 rounded-3xl bg-[rgba(15,16,17,0.6)] backdrop-blur-md border border-white/10 hover:border-[#5e6ad2]/35 hover:-translate-y-1 transition-all duration-300 cursor-default";
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <motion.div variants={cardVariant} className={`md:col-span-2 ${cardBase} space-y-6`}>
            ...
            <h3 className="font-grotesk text-2xl font-bold text-[#E6EEF7]">Cirurgiões & PAs</h3>
            ...
            <div className="flex gap-3 pt-1 flex-wrap">
              {["Neurocirurgia", "Coluna", "Crânio"].map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold uppercase tracking-wider text-[#8A8F98]"
                >
                  {tag}
                </span>
              ))}
          ...
          <motion.div variants={cardVariant} className={`${cardBase} flex flex-col justify-center space-y-6`}>
            ...
            <h3 className="font-grotesk text-2xl font-bold text-[#E6EEF7]">Faturamento</h3>
          ...
          <motion.div variants={cardVariant} className={`${cardBase} space-y-6`}>
            ...
            <h3 className="font-grotesk text-xl font-bold text-[#E6EEF7]">Instrumentadores</h3>
            <p className="text-[#8A8F98] text-sm leading-relaxed">
          ...
          >
            <div className="flex-1 space-y-4">
              <h3 className="font-grotesk text-2xl font-bold text-[#E6EEF7]">Consulta Documental</h3>
              <p className="text-[#8A8F98] leading-relaxed">
            ...
            <div className="w-full md:w-48 h-32 bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-xl border border-white/10 flex items-center justify-center flex-shrink-0">
