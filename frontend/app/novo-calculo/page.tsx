  ...
  return (
    <button
      ...
      style={{
        ...
        color: inactive ? "rgba(139, 126, 100,0.50)" : "#FFFFFF",
        border: inactive ? "1px solid rgba(139, 126, 100,0.20)" : "none",
        borderRadius: "10px",
      ...
      {loading && (
        <span
          ...
          style={{
            ...
            border: "2px solid rgba(139, 126, 100,0.3)", borderTopColor: "rgba(139, 126, 100,0.55)",
            borderRadius: "50%", display: "inline-block",
            animation: "spin 0.7s linear infinite",
          }}
        />
