...
const T = {
  bg:          "#F2EDE3",
  surface:     "#FFFFFF",
  cardBorder:  "rgba(132, 108, 59,0.12)",
  primary:     "#282011",
  secondary:   "#665D4A",
  muted:       "#8B7E64",
  inputBorder: "#DFD9CD",
    ...
    <main
      style={{
        ...
        background: [
          ...
          "radial-gradient(ellipse 700px 500px at 80% 20%, rgba(90, 72, 35,0.06) 0%, transparent 60%)",
          ...
          <Link href="/" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
            <div
              style={{
                ...
                borderRadius: "9px",
                border: "1px solid rgba(132, 108, 59,0.12)",
              }}
            >
...
function NavLink({ href, children, active, disabled, label }: NavLinkProps) {
  ...
  return (
    <Link
      ...
      onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "rgba(40, 32, 17,0.04)")}
  ...
  return (
    <Link
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.borderColor = "rgba(132, 108, 59,0.24)";
        e.currentTarget.style.boxShadow = "0 4px 12px rgba(40, 32, 17,0.08)";
      }}
      onMouseLeave={(e) => {
