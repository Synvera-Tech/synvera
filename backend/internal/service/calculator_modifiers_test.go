...
func TestModifiers_PerVertebraMultiplies(t *testing.T) {
	...
	got := CalculateWithPortesAndModifiers(codes, 0, false, models.AccessRouteSame, nil, modTestPortes, mods)
...
func TestModifiers_BilateralNoDuplicate(t *testing.T) {
	...
	withMods := CalculateWithPortesAndModifiers(codes, 0, false, models.AccessRouteSame, nil, modTestPortes, mods)
	...
	legacy := CalculateWithPortesAndModifiers(codes, 0, false, models.AccessRouteSame, nil, modTestPortes, nil)
...
func TestModifiers_SpineVia50EvenWhenDifferent(t *testing.T) {
	...
	got := CalculateWithPortesAndModifiers(codes, 0, false, models.AccessRouteDifferent, nil, modTestPortes, mods)
	...
	legacy := CalculateWithPortesAndModifiers(codes, 0, false, models.AccessRouteDifferent, nil, modTestPortes, nil)
...
func TestModifiers_NeurosurgeryUnchanged(t *testing.T) {
	...
	withMods := CalculateWithPortesAndModifiers(codes, 0, false, models.AccessRouteDifferent, nil, modTestPortes, mods)
	legacy := CalculateWithPortesAndModifiers(codes, 0, false, models.AccessRouteDifferent, nil, modTestPortes, nil)
